...
<body>
    <div class="wsal-report-container">
        ...
        <div class="wsal-report-footer">
            <p><?php echo esc_html__('This is an automated report generated by WP Site Activity Log. IP addresses and user details are not shown in this client report.', 'site-wise'); ?></p>
        </div>
    </div>
</body>
</html>