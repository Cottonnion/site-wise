...
<div class="wsal-card">
    <div class="wsal-card-header">
        <h2 class="wsal-card-title"><?php esc_html_e('Settings', 'syncly-site-reports'); ?></h2>
    </div>
        ...
        <form id="wsal-settings-form" class="wsal-settings-form" method="post">
            <div class="wsal-form-group">
                <label for="wsal-retention-days" class="wsal-label">
                    <?php esc_html_e('Log Retention (Days)', 'syncly-site-reports'); ?>
                </label>
                ...
                <small><?php esc_html_e('Logs older than this will be automatically deleted', 'syncly-site-reports'); ?></small>
            </div>
            ...
            <div class="wsal-form-group">
                <label class="wsal-label">
                    <span class="wsal-checkbox-row">
                        ...
                        <?php esc_html_e('Enable Shareable Reports', 'syncly-site-reports'); ?>
                    </span>
                </label>
            </div>
            ...
            <div class="wsal-form-group">
                <label for="wsal-report-period" class="wsal-label">
                    <?php esc_html_e('Report Period', 'syncly-site-reports'); ?>
                </label>
                <select id="wsal-report-period" name="report_period" class="wsal-select">
                    <option value="day" <?php selected($report_period, 'day'); ?>><?php esc_html_e('Today', 'syncly-site-reports'); ?></option>
                    <option value="week" <?php selected($report_period, 'week'); ?>><?php esc_html_e('Last 7 days', 'syncly-site-reports'); ?></option>
                    <option value="month" <?php selected($report_period, 'month'); ?>><?php esc_html_e('Last 30 days', 'syncly-site-reports'); ?></option>
                </select>
                <small><?php esc_html_e('Time range covered by the shareable report', 'syncly-site-reports'); ?></small>
            </div>

            <div class="wsal-settings-actions">
                <button type="submit" class="wsal-btn wsal-btn-primary">
                    <?php esc_html_e('Save Settings', 'syncly-site-reports'); ?>
                </button>
            </div>
        </form>
    </div>
